...
struct qt_meta_stringdata_Effect_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Effect_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Effect_t qt_meta_stringdata_Effect = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Effect"
...
QT_INIT_METAOBJECT const QMetaObject Effect::staticMetaObject = { {
    &Plugin::staticMetaObject,
    qt_meta_stringdata_Effect.data,
    qt_meta_data_Effect,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Effect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Effect.stringdata0))
