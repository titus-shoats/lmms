/****************************************************************************
** Meta object code from reading C++ file 'EqCurve.h'
**
...
#include "../../../plugins/Eq/EqCurve.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'EqCurve.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_EqCurve_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EqCurve_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EqCurve_t qt_meta_stringdata_EqCurve = {
    {
QT_MOC_LITERAL(0, 0, 7) // "EqCurve"
...
static const uint qt_meta_data_EqCurve[] = {
...
QT_INIT_METAOBJECT const QMetaObject EqCurve::staticMetaObject = { {
    &QGraphicsObject::staticMetaObject,
    qt_meta_stringdata_EqCurve.data,
    qt_meta_data_EqCurve,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_EqCurve.stringdata0))
        return static_cast<void*>(this);
    return QGraphicsObject::qt_metacast(_clname);
}
